...
let compareNums = (num1, num2) =>  num1 === num2  || num1 > num2 ? num1 : num2
...
let dogIntro = function (treat, toy) {
...
let phone1 = new Phone('Nokia', '7600', 200, 'black', false);

let phone2 = new Phone('HTC', 'One X', 20000, 'white', false);

let phone3 = new Phone('Apple', 'iPhone', 50000, 'white', false);
